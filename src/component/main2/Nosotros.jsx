        ...
        <div className="col-1" data-aos="fade-right">
          <div>
            <p>
              ...
              aceras y pisos. Dentro de las pinturas arquitectónicas tenemos
              tres líneas: Vkolor Profesional, nuestra línea superior; Vkolor
              Hogar siendo nuestra línea intermedia y la línea Vkolor
              Industrial.
            </p>
          </div>
        </div>

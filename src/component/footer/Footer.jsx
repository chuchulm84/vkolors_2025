      ...
      <div className="content__footer ">
        <div className="seccion__footer-2">
          <div className="container-text-footer">
            <div>
              <img src={tlf} alt="" className="icon-footer mt-1" />
              <p> 0424-2015915</p>
            </div>

            <div className="container-text-footer">
              <img src={email} alt="" className="icon-footer mt-2" />
              <p className="corection">francis@vkolor.com</p>
            </div>
            <div className="container-text-footer mt-1">
              <img src={direct} alt="" className="icon-footer" />
              <p className="corection1">Esquina miracielos a Hospital</p>
              <p className="corection1">EDIF: Sur 2 Local 14 Caracas,</p>
            </div>
          </div>
